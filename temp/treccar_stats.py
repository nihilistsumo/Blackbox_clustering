...
def trec_stats(art_qrels, top_qrels, hier_qrels, paratext_file, i):
    ...
    for p in page_paras.keys():
        ...
        curr_stat = [p, n, top_k, mean_top_k, std_top_k, min_top_k, max_top_k, hier_k, mean_hier_k, std_hier_k,
...
trec_stats(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], int(sys.argv[5]))